...
const VehiclePanel = (props) => {
  return (
    <div>
      <h5 className=" p-1 text-center w-[93%] absolute top-0" onClick={function(){
        ...
        }} className=" flex border-2 mb-2  border-gray-200 active:border-black  rounded-xl full p-3  items-center justify-between">
        ...
        <div onClick={()=>{
          ...
          <div className=" -ml-2  w-1/2">
              <h4 className=" font-medium text-base">UberAuto <span><i className="ri-user-fill"></i>4</span></h4>
              <h5 className=" font-medium text-sm">3 mins away</h5>
